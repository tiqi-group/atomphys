...
```
cd existing_repo
git remote add origin https://gitlab.phys.ethz.ch/tiqi-projects/optical-trap/atomphys_tiqi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.phys.ethz.ch/tiqi-projects/optical-trap/atomphys_tiqi/-/settings/integrations)
