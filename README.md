...
&= \sum_{\alpha, i, j} |i\rangle \frac{1}{2} \left( \left\langle i\left|e \mathbf{\dot{r}}^{(\alpha)} \mathbf{A}(\mathbf{x}) \right| j\right\rangle e^{-i\omega_lt} + \left\langle i\left|e \mathbf{\dot{r}}^{(\alpha)} \mathbf{A}^{\dagger}(\mathbf{x}) \right| j\right\rangle e^{i\omega_lt} \right) \langle j| \\
&= \sum_{\alpha, i, j} |i\rangle \frac{\hbar}{2} \left(\Omega_{ij} e^{-i\omega_lt} + \Omega^\dagger_{ij} e^{i\omega_lt} \right) \langle j| 
\end{aligned}
$$
...
$$
\mathcal{H}_L=-\sum_{i, j, l}|i\rangle \frac{1}{2}\left(\Omega_{ij}^{(l)} e^{-i \omega_l t}+ \Omega_{ij}^{\dagger(l)} e^{i \omega_l t}\right)\langle j|
$$
